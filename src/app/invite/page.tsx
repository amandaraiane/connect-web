    ...
    <div className="min-h-dvh flex items-center justify-between gap-16 flex-col md:flex-row">
      <div className="flex flex-col gap-10 w-full max-w-[550px]">
        ...
        <div className="space-y-6">
          ...
          <div className="grid gap-3 md:grid-cols-3">
            <div className="relative bg-gray-700 border border-gray-600 px-4 flex py-7 flex-col items-center justify-center gap-1 rounded-xl">
      ...
      <div className="w-full max-w-[440px] space-y-5">
        ...
        <div className="space-y-4">
          <div className="relative rounded-xl bg-gray-700 border border-gray-600 p-8 flex flex-col justify-center gap-2">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">1°</span> | Amanda Raiane
            </span>
          ...
          <div className="relative rounded-xl bg-gray-700 border border-gray-600 p-8 flex flex-col justify-center gap-2">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">2°</span> | Amanda Raiane
            </span>
          ...
          <div className="relative rounded-xl bg-gray-700 border border-gray-600 p-8 flex flex-col justify-center gap-2">
            <span className="text-sm text-gray-300 leading-none">
              <span className="font-semibold">3°</span> | Amanda Raiane
            </span>
